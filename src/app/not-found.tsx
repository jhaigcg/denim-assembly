...
export default function NotFound() {
  return (
    <div className="max-w-sheet mx-auto px-6 py-24 text-center">
      ...
      <Link
        href="/"
        className="inline-block mt-10 bg-ink text-paper px-[26px] py-4 font-sans text-[16px] font-medium rounded hover:bg-indigo hover:text-paper transition-colors"
      >

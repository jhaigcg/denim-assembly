    ...
    >
      <div className="grid gap-[clamp(32px,4vw,44px)] pb-[clamp(32px,4vw,44px)] border-b border-[rgba(246,246,244,0.16)] [grid-template-columns:repeat(auto-fit,minmax(210px,1fr))]">
        ...
        <div>
          ...
          <div className="flex flex-col gap-[9px] text-[15.5px] text-[#D4D7DE] keep-all">
            {t.termsList.map((x) => (
              <span key={x}>{x}</span>
            ))}
          </div>
      ...
      <div className="flex justify-between gap-5 pt-[22px] font-mono text-[12px] tracking-[0.1em] uppercase text-[#6E7691] flex-wrap">
